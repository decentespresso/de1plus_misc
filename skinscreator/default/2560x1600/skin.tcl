...
add_de1_button "preheat_2 steam water espresso" {say [translate {espresso}] $::settings(sound_button_out);set_next_page off off; start_idle} 642 0 1277 188
...
# espresso charts
add_de1_widget "espresso espresso_3" graph 30 265 {$widget element create line_espresso_pressure -xdata espresso_elapsed -ydata espresso_pressure -symbol none -label "" -linewidth 10 -color #40dc94  -smooth quadratic -pixels 0; $widget element create line_espresso_state_change_1 -xdata espresso_elapsed -ydata espresso_state_change -label "" -linewidth 6 -color #888888  -pixels 0 ; $widget axis configure x -color #5a5d75 -tickfont Helv_6 ; $widget axis configure y -color #5a5d75 -tickfont Helv_6 -min 0.0 -max $::de1(max_pressure);} -plotbackground #FFFFFF -width 1649 -height 328 -borderwidth 1 -background #FFFFFF -plotrelief flat
add_de1_widget "espresso espresso_3" graph 30 667 {$widget element create line_espresso_flow  -xdata espresso_elapsed -ydata espresso_flow -symbol none -label "" -linewidth 10 -color #4e85f4 -smooth quadratic -pixels 0; $widget element create line_espresso_state_change_2 -xdata espresso_elapsed -ydata espresso_state_change -label "" -linewidth 6 -color #888888  -pixels 0; $widget axis configure x -color #5a5d75 -tickfont Helv_6 ; $widget axis configure y -color #5a5d75 -tickfont Helv_6 -min 0.0 -max $::de1(max_flowrate); } -width 1649 -height 328  -plotbackground #FFFFFF -borderwidth 1 -background #FFFFFF -plotrelief flat
add_de1_widget "espresso espresso_3" graph 30 1070 {$widget element create line_espresso_temperature_basket -xdata espresso_elapsed -ydata espresso_temperature_basket -symbol none -label ""  -linewidth 10 -color #e73249 -smooth quadratic -pixels 0; $widget element create line_espresso_temperature_mix -xdata espresso_elapsed -ydata espresso_temperature_mix -label "" -linewidth 6 -color #ffa5a6 -smooth quadratic -pixels 0; $widget element create line_espresso_state_change_3 -xdata espresso_elapsed -ydata espresso_state_change -label "" -linewidth 6 -color #888888  -pixels 0; $widget axis configure x -color #5a5d75 -color #5a5d75 -tickfont Helv_6 ; $widget axis configure y -color #5a5d75 -tickfont Helv_6 -min $::de1(min_temperature) -max $::de1(max_temperature); } -width 1649 -height 328  -plotbackground #FFFFFF -borderwidth 0 -background #FFFFFF -plotrelief flat
...
add_de1_variable "off" 232 757 -text "" -font Helv_9_bold -fill "#2d3046" -anchor "center" -textvariable {[round_to_one_digits $::settings(preinfusion_flow_rate)] [translate "ml/s"]}
add_de1_variable "off" 490 490 -text "" -font Helv_9_bold -fill "#2d3046" -anchor "center" -textvariable {[round_to_one_digits $::settings(preinfusion_temperature)] [translate "ºC"]}
...
add_de1_variable "off" 1423 757 -text "" -font Helv_9_bold -fill "#2d3046" -anchor "center" -textvariable {[round_to_one_digits $::settings(preinfusion_stop_volumetric)] [translate "ml"]}
...
#add_de1_text "off" 490 490 -text [translate "94ºC"] -font Helv_9_bold -fill "#2d3046" -anchor "center" 
...
#add_de1_text "off" 835 757 -text [translate "1.5 ml/s"] -font Helv_9_bold -fill "#2d3046" -anchor "center" 
...
#add_de1_text "off" 1132 757 -text [translate "1.2 bar"] -font Helv_9_bold -fill "#2d3046" -anchor "center" 
...
#add_de1_text "off" 1423 757 -text [translate "45 ml"] -font Helv_9_bold -fill "#2d3046" -anchor "center" 
...
#add_de1_text "off" 1717 757 -text [translate "20s"] -font Helv_9_bold -fill "#2d3046" -anchor "center" 
...
add_de1_button "espresso_3" "set_next_page off off; page_show off" 1900 189 2560 620
